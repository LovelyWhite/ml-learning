...
def select_feat(train_data, valid_data, test_data, select_all=True):
    ...
    return raw_x_train[:, 1:-1], raw_x_valid[:, 1:-1], raw_x_test[:, 1:-1], y_train, y_valid
...
train_data, test_data = pd.read_csv(
    '/Users/lw/workspace/ml-learning/HW1/covid.train.csv').values, pd.read_csv('/Users/lw/workspace/ml-learning/HW1/covid.test.csv').values
